...
pub struct AppState {
    ...
    #[allow(dead_code)]
    pub upstream_proxy: Arc<tokio::sync::RwLock<crate::modules::proxy::config::UpstreamProxyConfig>>,
    pub upstream: Arc<crate::modules::proxy::upstream::client::UpstreamClient>,
    pub zai: Arc<RwLock<crate::modules::proxy::ZaiConfig>>,
    pub provider_rr: Arc<AtomicUsize>,
    pub zai_vision_mcp: Arc<crate::modules::proxy::zai_vision_mcp::ZaiVisionMcpState>,
    pub monitor: Arc<crate::modules::proxy::monitor::ProxyMonitor>,
    pub experimental: Arc<RwLock<crate::modules::proxy::config::ExperimentalConfig>>,
}
...
pub struct AxumServer {
    ...
    proxy_state: Arc<tokio::sync::RwLock<crate::modules::proxy::config::UpstreamProxyConfig>>,
    security_state: Arc<RwLock<crate::modules::proxy::ProxySecurityConfig>>,
    zai_state: Arc<RwLock<crate::modules::proxy::ZaiConfig>>,
}

impl AxumServer {
    pub async fn update_mapping(&self, config: &crate::modules::proxy::config::ProxyConfig) {
        {
    ...
    /// 更新代理配置
    pub async fn update_proxy(&self, new_config: crate::modules::proxy::config::UpstreamProxyConfig) {
        let mut proxy = self.proxy_state.write().await;
        *proxy = new_config;
        tracing::info!("上游代理配置已热更新");
    }

    pub async fn update_security(&self, config: &crate::modules::proxy::config::ProxyConfig) {
        let mut sec = self.security_state.write().await;
        *sec = crate::modules::proxy::ProxySecurityConfig::from_proxy_config(config);
        tracing::info!("反代服务安全配置已热更新");
    }

    pub async fn update_zai(&self, config: &crate::modules::proxy::config::ProxyConfig) {
    ...
    pub async fn start(
        ...
        upstream_proxy: crate::modules::proxy::config::UpstreamProxyConfig,
        security_config: crate::modules::proxy::ProxySecurityConfig,
        zai_config: crate::modules::proxy::ZaiConfig,
        monitor: Arc<crate::modules::proxy::monitor::ProxyMonitor>,
        experimental_config: crate::modules::proxy::config::ExperimentalConfig,
        ...
        let custom_mapping_state = Arc::new(tokio::sync::RwLock::new(custom_mapping));
	        ...
	        let zai_vision_mcp_state =
	            Arc::new(crate::modules::proxy::zai_vision_mcp::ZaiVisionMcpState::new());
            ...
            upstream: Arc::new(crate::modules::proxy::upstream::client::UpstreamClient::new(Some(
        ...
        use crate::modules::proxy::handlers;
        // 构建路由
        let app = Router::new()
            // OpenAI Protocol
            ...
            .layer(axum::middleware::from_fn_with_state(state.clone(), crate::modules::proxy::middleware::monitor::monitor_middleware))
            .layer(TraceLayer::new_for_http())
            .layer(axum::middleware::from_fn_with_state(
                security_state.clone(),
                crate::modules::proxy::middleware::auth_middleware,
            ))
            .layer(crate::modules::proxy::middleware::cors_layer())
            .with_state(state);

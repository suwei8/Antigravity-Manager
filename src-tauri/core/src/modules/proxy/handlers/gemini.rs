...
use crate::modules::proxy::mappers::gemini::{wrap_request, unwrap_response};
...
pub async fn handle_generate(
    ...
    for attempt in 0..max_attempts {
        ...
        let config = crate::modules::proxy::mappers::common_utils::resolve_request_config(&model_name, &mapped_model, &tools_val);

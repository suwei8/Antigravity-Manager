#[cfg(test)]
mod tests {
    use crate::modules::proxy::mappers::claude::models::{
        ClaudeRequest, Message, MessageContent, ContentBlock, ThinkingConfig, Tool
    };
    use crate::modules::proxy::mappers::claude::request::transform_claude_request_in;
    use crate::modules::proxy::mappers::claude::thinking_utils::{analyze_conversation_state, close_tool_loop_for_thinking};
    use serde_json::json;

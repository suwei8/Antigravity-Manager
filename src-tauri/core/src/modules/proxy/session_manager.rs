...
use crate::modules::proxy::mappers::claude::models::{ClaudeRequest, MessageContent};
use crate::modules::proxy::mappers::openai::models::{OpenAIRequest, OpenAIContent};
            ...
            if let Some(content) = &msg.content {
                let text = match content {
                    ...
                    OpenAIContent::Array(blocks) => {
                        blocks.iter()
                            .filter_map(|block| match block {
                                crate::modules::proxy::mappers::openai::models::OpenAIContentBlock::Text { text } => Some(text.as_str()),
                                _ => None,
                            })
                            .collect::<Vec<_>>()
                            .join(" ")

...
use super::models::*;
use crate::modules::proxy::mappers::signature_store::get_thought_signature;
...
pub fn transform_claude_request_in(
    ...
    let mapped_model = if has_web_search_tool {
        ...
        crate::modules::proxy::common::model_mapping::map_claude_model_to_gemini(&claude_req.model)
    };
    ...
    let config = crate::modules::proxy::mappers::common_utils::resolve_request_config(&claude_req.model, &mapped_model, &tools_val);
    ...
    crate::modules::proxy::mappers::common_utils::deep_clean_undefined(&mut inner_request);
    ...
    if config.inject_google_search && !has_web_search_tool {
        crate::modules::proxy::mappers::common_utils::inject_google_search_tool(&mut inner_request);
    }
                ...
                for item in blocks {
                    match item {
                        ...
                        ContentBlock::Thinking { thinking, signature, .. } => {
                            ...
                            crate::modules::proxy::common::json_schema::clean_json_schema(&mut part);
                            ...
                            if let Some(sig) = signature {
                                ...
                                let cached_family = crate::modules::proxy::SignatureCache::global().get_signature_family(sig);
                        ...
                        ContentBlock::ToolUse { id, name, input, signature, .. } => {
                            ...
                            let final_sig = signature.as_ref()
                                ...
                                .or_else(|| {
                                    ...
                                    crate::modules::proxy::SignatureCache::global().get_tool_signature(id)
                                        .map(|s| {
    ...
    if let Some(tools_list) = tools {
        ...
        for tool in tools_list {
            ...
            if let Some(name) = &tool.name {
                ...
                crate::modules::proxy::common::json_schema::clean_json_schema(&mut input_schema);
...
mod tests {
    use super::*;
    use crate::modules::proxy::common::json_schema::clean_json_schema;

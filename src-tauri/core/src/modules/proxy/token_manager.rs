...
use crate::modules::proxy::rate_limit::RateLimitTracker;
use crate::modules::proxy::sticky_config::StickySessionConfig;
...
impl TokenManager {
    ...
    async fn get_token_internal(&self, quota_group: &str, force_rotate: bool, session_id: Option<&str>) -> Result<(String, String, String), String> {
        ...
        use crate::modules::proxy::sticky_config::SchedulingMode;
    ...
    pub fn set_precise_lockout(&self, email: &str, reason: crate::modules::proxy::rate_limit::RateLimitReason, model: Option<String>) -> bool {
    ...
    pub async fn fetch_and_lock_with_realtime_quota(
        &self,
        email: &str,
        reason: crate::modules::proxy::rate_limit::RateLimitReason,
        model: Option<String>,
    ) -> bool {
    ...
    pub async fn mark_rate_limited_async(
        ...
        let reason = if error_body.to_lowercase().contains("model_capacity") {
            crate::modules::proxy::rate_limit::RateLimitReason::ModelCapacityExhausted
        } else if error_body.to_lowercase().contains("exhausted") || error_body.to_lowercase().contains("quota") {
            crate::modules::proxy::rate_limit::RateLimitReason::QuotaExhausted
        } else {
            crate::modules::proxy::rate_limit::RateLimitReason::Unknown
        };
